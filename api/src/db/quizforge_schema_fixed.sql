...
INSERT INTO classes (name, description, subject, grade_level, teacher_id)
VALUES 
  ('Introduction to Physics', 'Basic principles of physics', 'Physics', '9th Grade', '00000000-0000-0000-0000-000000000000')
ON CONFLICT DO NOTHING;

-- Update classes table to make subject and grade_level NOT NULL
ALTER TABLE classes 
